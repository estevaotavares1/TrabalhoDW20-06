    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="formEmprestimo.php">Alugar</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="cadastro_empresa.html">Cadastrar uma Empresa</a></li>
                            <li><a class="dropdown-item" href="cadastro_funcionario.html">Cadastrar um Funcionário</a></li>
                            <li><a class="dropdown-item" href="cadastro_pessoa.html">Cadastrar uma Pessoa</a></li>
                            <li><a class="dropdown-item" href="cadastro_veiculo.html">Cadastrar um Veículo</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
