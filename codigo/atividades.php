  ...
  <div class="container mt-5">
    ...
    <ul class="list-group">
      <li class="list-group-item">
        <a href="cadastro_pessoa.html" class="text-decoration-none">Cadastro de Pessoas</a>
      </li>
      <li class="list-group-item">
        <a href="cadastro_empresa.html" class="text-decoration-none">Cadastro de Empresas</a>
      </li>
      <li class="list-group-item">
        <a href="cadastro_funcionario.html" class="text-decoration-none">Cadastro de Funcionário</a>
      </li>
      <li class="list-group-item">
        <a href="cadastro_veiculo.html" class="text-decoration-none">Cadastro de Veículo</a>
      </li>
      <li class="list-group-item">
